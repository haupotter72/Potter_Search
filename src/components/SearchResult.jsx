  ...
  return (
    <div className="flex flex-col min-h-[100vh]">
      ...
      <main className="grow p-[12px] pb-0 md:pr-5 md:pl-20">
        <div className="flex text-sm  text-sky-700 font-extrabold mb-3">{`About ${searchInformation.formattedTotalResults} results in (${searchInformation.formattedSearchTime})`}</div>
        {!imageSearch ? (
          <>
